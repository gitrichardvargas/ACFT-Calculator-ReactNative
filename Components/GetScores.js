...
export class SoldierSimpleACFT extends SoldierScoreACFT {
  constructor(age, gender, dl, spt, hrp, sdc, plk, cardio, altCardio) {
      // Call the parent class constructor
      super(
          "N/A",            // rank isn't required for the simplified class
          "N/A",            // last name isn't required for the simplified class
          "N/A",            // first name isn't required for the simplified class
          age,
          gender,
          dl,
          spt,
